...
def run_training_for_lambda(cfg, lambda_val,
    ...
    # 1. Saving to a DISTINCT folder "_stage"
    out_dir = os.path.join(cfg.output_dir, f"{cfg.model_type}_stage_{stage_tag}_lambda_{lambda_val}")
    ...
    # 4. Transfer learning if checkpoint provided, lr schedule, optimizer
    ...
    # Save metrics table to a .txt file in the stage's model folder
