...
def main(cfg: DictConfig) -> None:
    X = torch.load(f"data/X_{cfg.data.dim}D_{cfg.data.constitutive_eq}.pt", weights_only=True)
    Y = torch.load(f"data/Y_{cfg.data.dim}D_{cfg.data.constitutive_eq}.pt", weights_only=True)
